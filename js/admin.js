...
document.getElementById('modify-profile').onclick = function () {
    console.log('Redirecting to modify profile page...');
    window.location.href = '/modify-profile.html'; // 출근부 조회 페이지로 리디렉션
};
/* global _config */
